...
namespace MptRoomAPI.Migrations
{
    ...
    [Migration("20250227110312_CreateCourseStudentM2M")]
    partial class CreateCourseStudentM2M
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MptRoomAPI.Models.AdditionalMaterialModel", b =>
                {
                    b.Property<int>("AddtionalMaterialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("AddtionalMaterialId"));
                    ...
                    b.HasKey("AddtionalMaterialId");

                    b.HasIndex("TaskModelPostId");

                    b.HasIndex("UserId");

                    b.ToTable("AddtionalMaterials");
                });
